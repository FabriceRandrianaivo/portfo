...
export const projects: ReadonlyArray<ProjectReadonly> = [
	...
	},
	{
		...
		technologies: ["React", "TypeScript", "Three.js", "React Three Fiber", "Google Gemini API", "MediaPipe", "Vercel"],
		...
		post: {
			fr: [
				...
				"Intégration de l'API Google Gemini pour une conversation intelligente et le contrôle des animations",
			...
			en: [
				...
				"Integrated Google Gemini API for intelligent conversation and animation control",
	...
	},
	{
		...
		description: {
			fr: "Site vitrine multi-pages pour une entreprise de services : présentation de l'offre, portfolio, blog, thème clair/sombre, widget de chat et calculateur de devis en ligne.",
			en: "Multi-page showcase website for a services company: offer presentation, portfolio, blog, light/dark theme, chat widget and online quote calculator.",
		},
		technologies: [
			"React 19",
			"TypeScript",
		...
		post: {
			fr: [
				"Développeur : conception et intégration du site vitrine multi-pages",
				"Thème clair/sombre, widget de chat et calculateur de devis en ligne",
				"SEO : meta tags dynamiques par page",
				"Design responsive desktop/mobile déployé sur Vercel",
			],
			en: [
				"Developer: design and integration of the multi-page showcase website",
				"Light/dark theme, chat widget and online quote calculator",
				"SEO: dynamic meta tags per page",
				"Responsive desktop/mobile design deployed on Vercel",
			],
		},
	},
	{
